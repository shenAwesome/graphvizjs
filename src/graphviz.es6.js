            ...
            function (cpp) {
                ...
                function getBinaryPromise() {
                    ...
                    return Promise.resolve().then(function () {
                        // var bin = new Uint8Array(wasmBinary)
                        //shen key change
                        return dataURItoBlob(wasmBinary)
                        //todo
                        return getBinary(wasmBinaryFile)
                    })
                }
                ...
                var _emscripten_bind_VoidPtr___destroy___0 = Module["_emscripten_bind_VoidPtr___destroy___0"] = function () {
                    return (_emscripten_bind_VoidPtr___destroy___0 = Module["_emscripten_bind_VoidPtr___destroy___0"] = Module["asm"]["z"]).apply(null, arguments)
                }
                var _emscripten_bind_Graphviz_Graphviz_2 = Module["_emscripten_bind_Graphviz_Graphviz_2"] = function () {
                    return (_emscripten_bind_Graphviz_Graphviz_2 = Module["_emscripten_bind_Graphviz_Graphviz_2"] = Module["asm"]["A"]).apply(null, arguments)
                }
                var _emscripten_bind_Graphviz_version_0 = Module["_emscripten_bind_Graphviz_version_0"] = function () {
                    return (_emscripten_bind_Graphviz_version_0 = Module["_emscripten_bind_Graphviz_version_0"] = Module["asm"]["B"]).apply(null, arguments)
                }
                var _emscripten_bind_Graphviz_lastError_0 = Module["_emscripten_bind_Graphviz_lastError_0"] = function () {
                    return (_emscripten_bind_Graphviz_lastError_0 = Module["_emscripten_bind_Graphviz_lastError_0"] = Module["asm"]["C"]).apply(null, arguments)
                }
                var _emscripten_bind_Graphviz_layout_3 = Module["_emscripten_bind_Graphviz_layout_3"] = function () {
                    return (_emscripten_bind_Graphviz_layout_3 = Module["_emscripten_bind_Graphviz_layout_3"] = Module["asm"]["D"]).apply(null, arguments)
                }
                var _emscripten_bind_Graphviz_createFile_2 = Module["_emscripten_bind_Graphviz_createFile_2"] = function () {
                    return (_emscripten_bind_Graphviz_createFile_2 = Module["_emscripten_bind_Graphviz_createFile_2"] = Module["asm"]["E"]).apply(null, arguments)
                }
                var _emscripten_bind_Graphviz___destroy___0 = Module["_emscripten_bind_Graphviz___destroy___0"] = function () {
                    return (_emscripten_bind_Graphviz___destroy___0 = Module["_emscripten_bind_Graphviz___destroy___0"] = Module["asm"]["F"]).apply(null, arguments)
                }
    ...
    if (!wasmLib.__hpcc_promise) {
        wasmLib.__hpcc_promise = wasmLib({
            ...
            locateFile: (path, prefix) => {
                const fileURL = `${trimEnd(wf || wasmFolder() || prefix || ".", "/")}/${trimStart(path, "/")}`
                return fileURL
            }
        })
    }
...
function graphvizSync(wasmBinary) {
    return loadWasm(graphvizlib$1, null, wasmBinary).then(wasm => new GraphvizSync(wasm))
}

export { GraphvizSync, graphviz, graphvizSync, graphvizVersion }
//# sourceMappingURL=graphviz.es6.js.map
